...
$website = "web-students.net/site126";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" placeholder="Your comments are important to me!" style="height:100px"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
